...
// Section 3 is "The Superblock", is that correct?
...
// Section 3 is "The Superblock", is that correct?
| u32[] | block sizes | An array of consecutive block sizes. See section 3 for details.
|===
...
// Is this really signed? It makes sense that the offsets in the entries
// are signed, but can this really be negative?
